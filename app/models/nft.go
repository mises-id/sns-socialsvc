...
type PaymentToken struct {
	Id       json.Number `json:"id" bson:"id"`
	Symbol   string      `json:"symbol" bson:"symbol"`
	Address  string      `json:"address" bson:"address"`
	ImageUrl string      `json:"image_url" bson:"image_url"`
	Name     string      `json:"name" bson:"name"`
	Decimals json.Number `json:"decimals" bson:"decimals"`
	EthPrice json.Number `json:"eth_price" bson:"eth_price"`
	UsdPrice json.Number `json:"usd_price" bson:"usd_price"`
}
...
type Ownership struct {
	...
	Quantity json.Number `json:"quantity" bson:"quantity"`
}
...
type Stats struct {
	...
	OneDaySales           json.Number `json:"one_day_sales" bson:"one_day_sales"`
	...
	SevenDaySales         json.Number `json:"seven_day_sales" bson:"seven_day_sales"`
	SevenDayAverage       float64     `json:"seven_day_average_price" bson:"seven_day_average"`
	...
	ThirtyDaySales        json.Number `json:"thirty_day_sales" bson:"thirty_day_sales"`
	...
	TotalSales            json.Number `json:"total_sales" bson:"total_sales"`
	TotalSupplyCount      json.Number `json:"total_supply" bson:"total_supply_count"`
	Count                 json.Number `json:"count" bson:"count"`
	NumOwners             json.Number `json:"num_owners" bson:"num_owners"`
	AveragePrice          float64     `json:"average_price" bson:"average_price"`
	NumReports            json.Number `json:"num_reports" bson:"num_reports"`
