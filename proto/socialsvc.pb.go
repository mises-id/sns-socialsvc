...
func (m *CgNext) Reset()         { *m = CgNext{} }
func (m *CgNext) String() string { return proto.CompactTextString(m) }
func (*CgNext) ProtoMessage()    {}
func (*CgNext) Descriptor() ([]byte, []int) {
	return fileDescriptor_565883138c05ff17, []int{17}
}
func (m *CgNext) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CgNext) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CgNext.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *CgNext) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CgNext.Merge(m, src)
}
func (m *CgNext) XXX_Size() int {
	return m.Size()
}
func (m *CgNext) XXX_DiscardUnknown() {
	xxx_messageInfo_CgNext.DiscardUnknown(m)
}

var xxx_messageInfo_CgNext proto.InternalMessageInfo

func (m *CgNext) GetLimit() uint64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *CgNext) GetLastRecommendTime() int64 {
	if m != nil {
...
func (m *CgNext) GetLastCommonTime() int64 {
	if m != nil {
...
type NewRecommendStatusResquest struct {
	CurrentUid        uint64 `protobuf:"varint,1,opt,name=current_uid,json=currentUid,proto3" json:"current_uid,omitempty"`
	ReqType           string `protobuf:"bytes,2,opt,name=req_type,json=reqType,proto3" json:"req_type,omitempty"`
	LastRecommendTime int64  `protobuf:"varint,3,opt,name=last_recommend_time,json=lastRecommendTime,proto3" json:"last_recommend_time,omitempty"`
	LastCommonTime    int64  `protobuf:"varint,4,opt,name=last_common_time,json=lastCommonTime,proto3" json:"last_common_time,omitempty"`
}

func (m *NewRecommendStatusResquest) Reset()         { *m = NewRecommendStatusResquest{} }
func (m *NewRecommendStatusResquest) String() string { return proto.CompactTextString(m) }
func (*NewRecommendStatusResquest) ProtoMessage()    {}
func (*NewRecommendStatusResquest) Descriptor() ([]byte, []int) {
	return fileDescriptor_565883138c05ff17, []int{18}
}
func (m *NewRecommendStatusResquest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *NewRecommendStatusResquest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_NewRecommendStatusResquest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *NewRecommendStatusResquest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_NewRecommendStatusResquest.Merge(m, src)
}
func (m *NewRecommendStatusResquest) XXX_Size() int {
	return m.Size()
}
func (m *NewRecommendStatusResquest) XXX_DiscardUnknown() {
	xxx_messageInfo_NewRecommendStatusResquest.DiscardUnknown(m)
}

var xxx_messageInfo_NewRecommendStatusResquest proto.InternalMessageInfo

func (m *NewRecommendStatusResquest) GetCurrentUid() uint64 {
	if m != nil {
		return m.CurrentUid
	}
	return 0
...
func (m *NewRecommendStatusResquest) GetReqType() string {
	if m != nil {
		return m.ReqType
	}
	return ""
...
func (m *NewRecommendStatusResquest) GetLastRecommendTime() int64 {
	if m != nil {
		return m.LastRecommendTime
	}
	return 0
...
func (m *NewRecommendStatusResquest) GetLastCommonTime() int64 {
	if m != nil {
		return m.LastCommonTime
	}
	return 0
...
type NewRecommendStatusResponse struct {
	Code     uint64        `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Statuses []*StatusInfo `protobuf:"bytes,2,rep,name=statuses,proto3" json:"statuses,omitempty"`
	Next     *CgNext       `protobuf:"bytes,3,opt,name=next,proto3" json:"next,omitempty"`
...
func (m *NewRecommendStatusResponse) GetNext() *CgNext {
	if m != nil {
		return m.Next
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CgNext)(nil), "socialsvc.CgNext")
...
func (c *socialClient) NewRecommendStatus(ctx context.Context, in *NewRecommendStatusResquest, opts ...grpc.CallOption) (*NewRecommendStatusResponse, error) {
...
func (*UnimplementedSocialServer) NewRecommendStatus(ctx context.Context, req *NewRecommendStatusResquest) (*NewRecommendStatusResponse, error) {
...
func _Social_NewRecommendStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewRecommendStatusResquest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).NewRecommendStatus(ctx, req.(*NewRecommendStatusResquest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *CgNext) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *CgNext) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *NewRecommendStatusResquest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *NewRecommendStatusResquest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.ReqType) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintSocialsvc(dAtA, i, uint64(len(m.ReqType)))
		i += copy(dAtA[i:], m.ReqType)
	}
	if m.LastRecommendTime != 0 {
		dAtA[i] = 0x18
		i++
...
func (m *NewRecommendStatusResquest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CgNext) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CgNext: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CgNext: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *NewRecommendStatusResquest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: NewRecommendStatusResquest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: NewRecommendStatusResquest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
